...
/*   Updated: 2020/10/08 20:46:58 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap( void )
{
	...
	std::cout <<"FR4G-TP < \033[1;37m" << _Name << "> a été créé avec succès !" << std::endl;
}
...
FragTrap::FragTrap( std::string pName)
{
	...
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > a été créé avec succès !" << std::endl;
}
...
{
	std::cout <<"FR4G-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > a été détruit avec succès !" << std::endl;
}
